        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="/add-product-script" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="prev_price" id="prev_price" step="0.01" class="mt-1 border-2 outline-none p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
